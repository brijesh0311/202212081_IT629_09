...
const Home = () => {
  ...
  return (
    <>
      ...
      <h1 style={{color:"pink",fontFamily:"Times and New",textAlign:"right",}}>Brijesh Gandhi</h1>
      <h1 style={{color:"pink",fontFamily:"Times and New",textAlign:"right",}}>202212081</h1>
    </>
  );
};
